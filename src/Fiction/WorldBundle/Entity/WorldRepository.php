...
class WorldRepository extends EntityRepository
{
	...
	public function findChildWorlds($worldId, $perPage, $page = 1)
	{
	...
	public function getFilteredWorlds($data, $perPage, $page = 1)
	{
		$query = $this->createQueryBuilder('f');
	...
	public function findWorlds($perPage, $page = 1)
	{
		$query = $this->createQueryBuilder('f');
	...
	public function findUserWorld($worldId, $user)
	{
		$query = $this->createQueryBuilder('f');
	...
	public function getTotalWorlds()
	{
		return $this->getEntityManager()
			->createQuery('SELECT COUNT(f.id) FROM FictionWorldBundle:World f')
			->getSingleScalarResult();
	}

	public function getTotalFilteredWorlds($data)
	{
		$query = $this->createQueryBuilder('f');
		$data->getCategories()->first();
		$categoryIdArray = array ();
